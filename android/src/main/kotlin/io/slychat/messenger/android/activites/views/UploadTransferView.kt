...
class UploadTransferView(
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.upload_transfer, this, true)
    ...
    private fun setTransferInfo(transferStatus: AndroidTransferStatus) {
        mTransferFileName.text = transferStatus.transfer.localDisplayName
