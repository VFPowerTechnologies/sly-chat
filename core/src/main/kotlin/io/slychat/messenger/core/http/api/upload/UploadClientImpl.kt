...
class UploadClientImpl(
    ...
    override fun uploadPart(userCredentials: UserCredentials, uploadId: String, partN: Int, size: Long, inputStream: InputStream, isCancelled: AtomicBoolean): UploadPartCompleteResponse {
